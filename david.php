...
<center>
    <img src="https://licoresbuhosnocturnos.com/wp-content/uploads/2021/07/logo-buho-nocturno.png" width="200">
</center>
<h1>
 ESPERANDO PEDIDO...
</h1>
...
$con=mysqli_connect('50.31.174.210','licoresbuhosnoct_6','r8j)S3Np7)','licoresbuhosnoct_6');
...
$printer->text("-----------------------------"."\n");
    ...
    $consulta2PR = "SELECT * FROM `wpc7_woocommerce_order_items` WHERE `order_id` = ".$ids."";
    $result1PR = mysqli_query($con, $consulta2PR);
    $printer->setJustification(Printer::JUSTIFY_LEFT);
    while($crow1PR = mysqli_fetch_assoc($result1PR)) {
    $idcan = $crow1PR['order_item_id']; 

    $preccant = "SELECT * FROM `wpc7_woocommerce_order_itemmeta` WHERE `order_item_id` = ".$idcan." AND meta_key = '_line_total'";
    ...
    $preccant = "SELECT * FROM `wpc7_woocommerce_order_itemmeta` WHERE `order_item_id` = ".$idcan." AND meta_key = '_QTY'";
    $result1PRca = mysqli_query($con, $preccant);
    while($crow1PRcant = mysqli_fetch_assoc($result1PRca)) {
    ...
    $printer->text(" ".$nombredeproductoid." | ".$nombredeproducto." | $".$TOTAL."\n");
        ...
        $preccantsum = "SELECT * FROM `wpc7_woocommerce_order_itemmeta` WHERE `order_item_id` = ".$idcan." AND meta_key = '_line_total'";
...
$suma_total = 0;
        ...
        $ttot = "SELECT * FROM `wpc7_postmeta` WHERE `post_id` = ".$ids." AND `meta_key` = '_order_total'";
...
$printer->text("https://buhosnocturnos.com/" . "\n");
$printer->text("" . "\n");
...
$sql = "UPDATE  wpc7_posts set impe  = '0' where  ID = ".$ids."";
        $result = mysqli_query($con, $sql);                 
