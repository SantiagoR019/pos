...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($data['id'])) {
        ...
        // Consulta para obtener el pedido que coincide con el correo de Madelena
        $sql = "SELECT * FROM `wp_wc_orders` 
                WHERE id = $order_id 
                AND status = 'wc-completed' 
                AND billing_email LIKE '%madelena@buhosnocturnos.co%' 
                AND impreso = '0'";
        ...
        if ($result && mysqli_num_rows($result) > 0) {
            ...
            */
            ...
            // Si no coincide con el correo de Madelena, no imprime
            error_log("El pedido no pertenece al correo de Madelena o ya fue impreso.");
        }
    }
}
?>
